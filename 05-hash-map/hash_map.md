...
## Проблемът с търсенето

- В ArrayList и Linked List търсенето е **O(n)**
- Трябва да обходим всеки елемент, докато намерим търсения

```
Търсим 40 в: [10, 25, 30, 40, 55]
              ↑    ↑    ↑    ↑
           проверка по проверка...
```

- Какво ако искаме търсене, вмъкване и изтриване в **O(1)**?
